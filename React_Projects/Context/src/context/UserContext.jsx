...
//create context
export const UserContext = createContext(); //! createContext() creates a global data container (context) for your React app.
...
Context value → the data itself. (Context value = user and setUser)
